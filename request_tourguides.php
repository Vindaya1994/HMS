								...
								<td>
										...
										<table style="cellspacing:10; cellpadding:10">
											...
											<tr>
												...
												<td>&nbsp LKR &nbsp <?php echo $row['price_per_hour']?></td>
											</tr>
											<tr><td>&nbsp </td><td>&nbsp </td></tr>
											
										</table>
										<a href="form_request_tg.php"><button class="w3-button w3-block w3-green w3-section w3-padding" type="submit" name="submit">REQUEST</button</a>
