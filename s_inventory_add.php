											    ...
											    <div class=" w3-col s12 w3-margin">
												    <div class="w3-card-4 w3-col s12 w3-margin w3-border-black">			
													    <div class="w3-container w3-padding ">	
														    <div class="row w3-margin w3-xxxlarge "><img src="assets/img/inventory/file.png" style="width:21%">&nbsp;</i>Enter Item
                                                            </div>
													    </div>
													    <div class="w3-container w3">
														    <form   id="item-add" method="post" action="./config/system_user.php" enctype="multipart/form-data">
															    ...
															    <div class="w3-half w3-padding">      
                                                                    <input class="w3-input w3-border" name="name" type="text" placeholder="Item name"   >   
                                                                </div>
																<div class="w3-half w3-padding">      
                                                                    <input class="w3-input w3-border" name="price" type="text" placeholder="Unit price"   >   
                                                                </div>
																<div class="w3-half w3-padding">      
                                                                    <input class="w3-input w3-border" name="total" type="text" placeholder="Total stock"   >   
                                                                </div>
																<div class="w3-half w3-padding">      
                                                                    <input class="w3-input w3-border" name="minimum" type="text" placeholder="Minimum stock"   >   
                                                                </div>

													    
																<div class="w3-row-padding w3-margin-bottom">	
																<div class="w3-half">
																	<input type="submit" class="w3-btn w3-green w3-block " name="item-add" value="Add Item">
																</div> 
																<div class="w3-half">
																	<input type="reset" class="w3-btn w3-red w3-block " name="item-add-cancel" value="Cancel">
																</div>								
															</div>
