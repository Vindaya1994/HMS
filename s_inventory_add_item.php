											    ...
											    <div class=" w3-col s12 w3-margin">
												    <div class="w3-card-4 w3-col s12 w3-margin w3-border-black">			
													    <div class="w3-container w3-padding ">	
														    <div class="row w3-margin w3-xxxlarge "><img src="assets/img/inventory/file.png" style="width:21%">&nbsp;</i>Add item
                                                            </div>
													    </div>
													...
													<div class="w3-padding">									
														<button class="btn w3-green" name="adding" type="submit" style="width:950px;height:50px;">Add Item</button>
                                                    </div>
														    </form>			
											</div>							
										</div> 
