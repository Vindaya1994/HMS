											    ...
											    <div class=" w3-col s12 w3-margin">
												    <div class="w3-card-4 w3-col s12 w3-margin w3-border-black">			
													    <div class="w3-container w3-padding ">	
														    <div class="row w3-margin w3-xxxlarge "><img src="assets/img/dinning/admin/meal2.png" style="width:21%">&nbsp;</i>Add Establishment Type
                                                            </div>
													    </div>
													    <div class="w3-container w3">
														    <form   id="e-add" method="post" action="./config/system_user.php" enctype="multipart/form-data">
			
															    <div class=" w3-padding">      
                                                                    <!--add type-->
																	<div class="w3-padding w3-col s6">
																		<input class="w3-input w3-border" name="eid" type="text" placeholder="Add establishment Type" ></div>
																	<div class="w3-padding w3-col s6 ">
																		<input class="w3-input w3-border" name="ename" type="text" placeholder="Add Establishemnt Type Name" ></div> <br><br>
																</div>
																<br><br>
																<div class="w3-row-padding w3-margin-bottom">	
																	<div class="w3-half">						
																		<input type="submit" class="w3-btn w3-green w3-block " name="establishment-add" value="Add Establishment Type">
																	</div> 
																	<div class="w3-half">
