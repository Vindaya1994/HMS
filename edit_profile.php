                ...
                <div class="w3-col w3-border-left" style="width:70%">
                    ...
                    <div id="ep" class="w3-container city w3-animate-right" style="display:">
                        ...
                        <?php
													...
													$myrow =$obj ->viewCustomer('customer',$cus_id);
                            ...
                            <input type="hidden"  name="cus_id" value="<?php echo $cus_id ?>">
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $row['cus_fname'] ?>"class="form-control" name="fname"  placeholder="Enter first name" id="fname"  >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10"> 
                                            <input type="text" value="<?php echo $row['cus_lname'] ?>"class="form-control" name="lname"  placeholder="Enter last name" id="lname">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="date of birth">Date of birth:</label>
                                        <div class="col-sm-10"> 
                                            <input  type="date"value="<?php echo $row['dob'] ?>" class="form-control" name="birthdate" placeholder="Enter date of birth"  id="birthdate">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="county">Country:</label>
                                        <div class="col-sm-10"> 
                                            <input type="text"value="<?php echo $row['country'] ?>" class="form-control" name="country"  placeholder="Enter country" id="country">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="email">Email:</label>
                                        <div class="col-sm-10"> 
                                            <input type="text"value="<?php echo $row['cus_email'] ?>" class="form-control" name="email"   placeholder="Enter email" id ="email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group"> 
                                        <div class="col-sm-offset-2 col-sm-10 ">
                                            <button type="submit" class="button w3-green" name="updatecus" id="updatecus" style="width:100%; height:40px"	>Update</button> 
                                        </div>
                                    </div>
                    ...
                    <div id="pc" class="w3-container city w3-animate-right" style="display:none">
                        ...
                        <input type="hidden"  name="cus_id" value="<?php echo $cus_id ?>">
                            ...
                            <div class="form-group"> 
                                        <div class="col-sm-offset-2 col-sm-10 ">
                                            <button type="submit" class="button w3-green" name="changepwd" id="changepwd" style="width:100%; height:40px"	>Change Password</button> 
                                        </div>
                                    </div>
