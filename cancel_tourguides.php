			...
			<div class="section-page-heading row  ">
				<div class="breadcrumb-leftnav-wrapper ">
					<div class="col-md-12 col-lg-10 col-lg-offset-1 ">
						<ul class="breadcrumb">
							...
							<li class="active"><span class="last">Cancel Tour Guide reservation</span></li>
						</ul>
				...
				<div class="section-page-content row">
					<div class="col-lg-10 col-lg-offset-1">
						<div class="col-lg-10 col-lg-offset-1">
						<p>The Tenth Hotel Ella is always there to make your jorney perfect. We can allow you to cancel your tour guide request atleast two days before your tour.</p>
						...
						<div class="w3-row">
                            <div class="w3-display-container w3-content" style="max-width:1600px;">
                                	...
                                	<div class="w3-container w3-white w3-padding-16 w3-center">
										...
										<!--form-->
                                        <form class="w3-container" action="./config/customer.php" id="tour_guide_cancel_form" method="POST" enctype="multipart/form-data">
										
                                        <!--current tourguide requests-->
										<?php
										...
										<p>Are you sure to cancel your request?</p>
											<div class="w3-row">
                                				<button class="btn w3-green" style="width:500px" name="tour_guide_cancel" type="submit">Yes</button><br>     
                                				<button class="btn w3-red"  style="width:500px" name="not_tour_guide_cancel"type="reset"  >No</button>
											</div> 
										</form>	
                                	</div>
								</div>
