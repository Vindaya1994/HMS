											...
											<div class=" w3-col s12 w3-margin">
												<div class="w3-card-4 w3-col s7 w3-margin">			
													...
													<!--<div class="row  w3-xxxlarge " style="padding-left:16px"><img src="img/Fast-Food-icon.png" style="width:15%">&nbsp;&nbsp;</i> Meal List </div>-->
														<div class="row w3-margin w3-xxlarge "><img src="assets/img/vacancies/job2.png" style="width:21%">&nbsp;</i>Enter Job Vacancy </div>
													</div>
													<div class="w3-container w3" style="height:320px">
														<form   id="s_jobvacancies_add" method="post" action="./config/system_user.php" enctype="multipart/form-data">
															<div class="w3-half w3-padding">      
																<input class="w3-input w3-border" name="vac_id" type="text" placeholder=" Vacancy ID" ></div>
															<div class="w3-half w3-padding">      
																<input class="w3-input w3-border" name="position" type="text" placeholder=" Position" ></div>
															<div class="w3-half w3-padding">      
																<input class="w3-input w3-border" name="salary" type="text" placeholder="Salary"></div>
															<div class="w3-padding">
																<input class="w3-input w3-border" name="contract" type="text" placeholder="Contract" ></div>
                                                            <div class="w3-padding">
																<input class="w3-input w3-border" name="desc" type="text" placeholder="Job description" style="height:150px" ></div>
												...
												<div class="w3-card-4 w3-col s4 w3-margin w3-padding w3-center" >
													<div class="w3-padding ">
														<h2>Upload a photo</h2><hr/>
															<div id="imageVal" style="width:100%;height:100%"><img id="myImg" src="assets/img/vacancies/job2.png" alt="meal image" class="w3-image" /></div>
													...
													<div class="w3-row-padding w3-margin-bottom">	
														<div class="w3-half">
															<input type="submit" class="w3-btn w3-green w3-block " name="job_vacany_add" value="Add Job Vacancy">
														</div> 
														<div class="w3-half">
