											...
											<div class=" w3-col s12 w3-margin">
												<div class="w3-card-4 w3-col s12 w3-margin">			
													...
													<!--<div class="row  w3-xxxlarge " style="padding-left:16px"><img src="img/Fast-Food-icon.png" style="width:15%">&nbsp;&nbsp;</i> Meal List </div>-->
														<div class="row w3-margin w3-xxlarge "><img src="assets/img/customer/customericon.png" style="width:21%">&nbsp;</i>Add Customer </div>
													</div>
													<div class="w3-container w3">
														<form   id="customer-add" method="post" action="./config/system_user.php" enctype="multipart/form-data">
															...
															<div class="w3-padding">
                                            					...
                                            					value="<?php if(isset($_POST['dob'])){ echo $_POST['dob']; }     ?>"></div>
                                                            <div class="w3-padding">
																<input class="w3-input w3-border" name="country" type="text" placeholder="Country" ></div>
                                                            <div class="w3-padding">
															...
															<div class="w3-row-padding w3-margin-bottom">	
																<div class="w3-half">
																	<input type="submit" class="w3-btn w3-green w3-block " name="customer-add" value="Add Customer">
																</div> 
																<div class="w3-half">
