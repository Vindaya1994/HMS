											    ...
											    <div class=" w3-col s12 w3-margin">
												    <div class="w3-card-4 w3-col s12 w3-margin w3-border-black">			
													    <div class="w3-container w3-padding ">	
														    <div class="row w3-margin w3-xxxlarge "><img src="assets/img/bedRooms/Roomicon.png" style="width:21%">&nbsp;</i>Enter reservation
                                                            </div>
													    </div>
													    <div class="w3-container w3">
														    <form   id="admin-reservation" method="post" action="./config/system_user.php" enctype="multipart/form-data">
                                                                ...
                                                                <input type="date" class="form-control " name="check_out" required placeholder="Enter date of check out "  
													...
													<div class="w3-row-padding w3-margin-bottom">	
														<div class="w3-half">						
															<input type="submit" class="w3-btn w3-green w3-block " name="reservation-add" value="Add Reservation">
														</div> 
														<div class="w3-half">
